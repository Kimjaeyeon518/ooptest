...
//
//        Float totalDamage = (fightResponseDto.getGameCharacterResponseDto().getAttackPower() - reflectedMonsterResponseDto.getDefensePower());
...
//        fightResponseDto.setMonster(originalMonsterResponseDto);
